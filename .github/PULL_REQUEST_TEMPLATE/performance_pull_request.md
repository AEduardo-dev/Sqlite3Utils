...
* The pull request must only improve the performance. To contribute other changes, you must use a different template. You can see all templates at <https://github.com/AEduardo-dev/Sqlite3Utils/PULL_REQUEST_TEMPLATE.md>.
* The pull request must update the test suite to demonstrate the change functionality.
